...
import ListAds from '../Corporate/ListAds';
import AddPromotion from '../Corporate/AddPromotion';
import AddRefreshSlot from '../Corporate/AddRefreshSlot';
...
import Home_icon_white from '../assets/svg/menu/home-icon-black.svg';
import Category_icon_white from '../assets/svg/menu/category-icon-black.svg';
import User_feed_icon_white from '../assets/svg/menu/user-feed-icon-black.svg';
import Mygallery_icon_white from '../assets/svg/menu/my-gallery-icon-white.svg';
import Notification_icon_white from '../assets/svg/menu/notification-icon-black.svg';
import Languages_icon_white from '../assets/svg/menu/languages-icon-black.svg';
import About_icon_white from '../assets/svg/menu/about-us-Icon-black.svg';
import Contact_icon_white from '../assets/svg/menu/contact-icon-black.svg';
import Terms_and_Conditions_icon_white from '../assets/svg/menu/terms-and-conditions-icon-black.svg';
...
// import JobsOther from '../OtherProfile/Jobs';
// import PropertiesOther from '../OtherProfile/Properties';
...
import AddMyDeals from '../Corporate/AddMyDeals';
import MyDeals from '../Corporate/MyDeals';
import ViewUsers from '../UserProfile/ViewUsers';
...
const RoutesAuth = () => {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="AddMyDeals" component={AddMyDeals} />

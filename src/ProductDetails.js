...
export default class ViewProduct extends Component {
  ...
  viewImage(url) {
    ...
    this.setState(
      {
        imageViewerImages: this.state.product.imageFiles.map(c => ({
  ...
  async getProduct(id) {
    ...
    await ApiHelper.get(API.productSlug + id)
      .then(res => {
      ...
      <Container>
        ...
        <View
          ...
          <ScrollView
            ...
            {'imageFiles' in this.state.product &&
            this.state.product.imageFiles.length ? (
              <View style={{marginTop: -6}}>
                <Carousel
                  ...
                  loop={true}
                  loopClonesPerSide={this.state.product.imageFiles.length}
                  autoplay={true}
                  autoplayDelay={500}
              ...
              {!this.state.product.bestDeal && 'price' in this.state.product ? (
                <View style={style.contacts}>
                  ...
                  <Text
                    ...
                    QAR {this.state.product.price}
                  </Text>
                </View>
              ) : null}
              {this.state.product.bestDeal &&
              'actualPrice' in this.state.product ? (
                <View style={style.contacts}>
                  <TagSvg width={20} height={20} />
                  <Text
                    style={[
                  ...
                  <Text
                    ...
                    {this.state.product.actualPrice}
                  </Text>
                  <Text
                    style={[
                      theme.fontRegular,
                  ...
                  <Text
                    ...
                    ({this.state.product.discountValue}%)
                  </Text>
                </View>
              ) : null}
              {'mapDetails' in this.state.product &&
              this.state.product.mapDetails ? (
                <View style={style.contacts}>
                  <LocatioPinSvg width={20} height={20} />
                  <Text style={[theme.fontRegular, {marginLeft: 13}]}>
                    {this.state.product.mapDetails.addressString}
                  </Text>
                </View>
              ) : null}
              {'contactDetails' in this.state.product &&
              this.state.product.contactDetails ? (
                <View style={style.contacts}>
                  ...
                  <Text style={[theme.fontRegular, {fontStyle: 'italic'}]}>
                    {this.state.product.contactDetails.contactTimeFrom}
                  </Text>
                  <Text style={[theme.fontRegular]}> to </Text>
                  <Text style={[theme.fontRegular, {fontStyle: 'italic'}]}>
                    {this.state.product.contactDetails.contactTimeTo}
                  </Text>
                </View>
              ) : null}
              {'userDetails' in this.state.product ? (
                <View
                  style={{
                    flexDirection: 'row',
                    margin: 10,
                  ...
                  <View
                    ...
                    {'profilePic' in this.state.product.userDetails ? (
                      <View
                        style={{
                          borderWidth: 2,
                          borderColor: 'red',
                        ...
                        <Thumbnail
                          source={{
                            uri:
                              CONSTANTS.SMALL_IMG +
                              this.state.product.userDetails.profilePic,
                          }}
                          style={{
                            width: 52,
                            height: 52,
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        this.props.navigation.navigate('UserMenuTabsOther', {
                          initialPage: 4,
                          userId: this.state.product?.userDetails?._id,
                        });
                      }}>
                      <Text
                        style={[
                        ...
                        {this.state.product.userDetails.name}
                      </Text>
                    </TouchableOpacity>
                  </View>
                  <View
            ...
            {'brandName' in this.state.product &&
            this.state.product.brandName ? (
            ...
            {'shortDescription' in this.state.product &&
              ...
              {'contactDetails' in this.state.product ? (
                <View
                  ...
                  <Text
                    ...
                    {/* {this.state.product.userId.name} */}
                    Contact Information
                  </Text>
                  <View
                    style={{
                    ...
                    <View
                      ...
                      <Text
                        ...
                        selectable>
                        {this.state.product.contactDetails.contactName}
                      </Text>
                    </View>
                    <View
                      style={{
                          ...
                          onPress={() =>
                            Linking.openURL(
                              'tel:' +
                                ...
                                this.state.product.contactDetails.contactNumber,
                            )
                          }
                          title={
                            CONSTANTS.COUNTRY_CODE_TEXT +
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          Linking.openURL(
                            'mailto:' +
                              this.state.product.contactDetails.contactEmail,
                          )
                        }
                        title={this.state.product.contactDetails.contactEmail}>
                        <Text
                          style={{
                            fontFamily: 'Roboto-Medium',
                            color: '#5f5f5f',

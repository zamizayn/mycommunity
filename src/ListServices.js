...
export default class ListServices extends Component {
  ...
  async getPromotedList() {
    await ApiHelper.get(API.servicesPromoted)
      .then(res => {
  ...
  async getServices() {
    ...
    await ApiHelper.get(API.services + url)
      .then(res => {
        console.log(res);
        if ('data' in res.data && res.data.data) {
          var dataLen = res.data.data;
                  ...
                  <ListItem
                    ...
                    <Body style={{}}>
                      ...
                      <Text
                        style={[
                          theme.fontBold,
                          {fontSize: width / 27, color: '#bd1d53'},
                        ]}
                        note
                        numberOfLines={1}>
                       QAR {item.price}
                      ...
                      <View
                        ...
                        {/* <WebView
                          ...
                          source={{
                            html:
                              '<html><head><meta name="viewport" content="width=device-width, initial-scale=0.7"><style>body {  } </style></head><body>' +
                              item?.description +
                              '</body></html>',
                          }}

...
export default class MyDealsDetails extends Component {
  constructor() {
    super();
    this.state = {
      checked: false,
  ...
  async getService(id) {
    ...
    await ApiHelper.get(API.myDealDetails + id + '/public')
      .then(res => {
        ...
        <View
          ...
          <ScrollView
            ...
            <View style={[style.businessInfoContent]}>
              ...
              {moment().isSameOrBefore(this.state.service?.endDateTime) ? (
                <Text
                  style={[
                    theme.fontBold,
                    {
                  ...
                  <TimeAgo
                    live={false}
                    component={Text}
                    date={this.state.service?.endDateTime}
                  />
                </Text>
              ) : (
                <Text
                  ...
                  <View
                      ...
                      <View
                        ...
                        <TouchableOpacity
                          onPress={() =>
                            Linking.openURL(
                              'tel:' +
                                this.state.service.userDetails.ccd +
                                this.state.service.userDetails.mobile,
                            )
                          }
                          title={
                            (this.state.service.userDetails.ccd,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          Linking.openURL(
                            'mailto:' + this.state.service.userDetails?.email,
                          )
                        }
                        title={this.state.service.userDetails?.email}>
                        <Text
                          style={{
                            fontFamily: 'Roboto-Medium',
                            color: '#5f5f5f',
                          ...
                          selectable>
                          {this.state.service.userDetails?.email}
                        </Text>
                      </TouchableOpacity>
                    </View>
                  </View>

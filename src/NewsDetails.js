...
export default class NewsDetails extends Component {
  ...
  async getService(slug) {
    ...
    await ApiHelper.get(API.newsDetails + slug)
      .then(res => {
        ...
        <View
          ...
          <ScrollView
            ...
            <View style={[style.businessInfoContent]}>
              ...
              <Text style={[theme.fontBold, {fontSize: width / 36}]}>
                by {this.state.service?.author}
              </Text>
              <Text
                style={[
                  theme.fontRegular,
            ...
            {'content' in this.state.service && this.state.service?.content ? (
              <View style={[style.aboutContent]}>
                {/* <Text style={[theme.fontBold, {fontSize: width / 25}]}>
                  Description
                </Text>
                ...
                <RenderHtml
                  contentWidth={width}
                  source={{
                    html: this.state.service?.content,
                    // .replace(/\n/g, '')
                    // .replace(/<br>/g, '')

...
export default class ShopDetails extends Component {
  ...
  viewImage(url) {
    ...
    this.setState(
      {
        imageViewerImages: this.state.service.bannerImages.map(c => ({
  ...
  async getService(slug) {
    ...
    await ApiHelper.get(API.shopDetails + slug)
      .then(res => {
      ...
      <Container>
        ...
        <View
          ...
          <ScrollView
            ...
            {'bannerImages' in this.state.service &&
            this.state.service?.bannerImages?.length ? (
              <View style={{marginTop: -6}}>
                <Carousel
                  ...
                  data={this.state?.service?.bannerImages}
                  ...
                  loop={true}
                  loopClonesPerSide={this.state?.service?.bannerImages?.length}
                  autoplay={true}
                  autoplayDelay={500}
            ...
            {'mallDetails' in this.state?.service &&
            this.state.service?.mallDetails ? (
              <View style={[style.aboutContent]}>
                <Text style={[theme.fontBold, {fontSize: width / 25}]}>
                  Address
                </Text>
                <Text
                  ...
                  {this.state.service?.mallDetails?.address}
                </Text>
              </View>
            ) : null}

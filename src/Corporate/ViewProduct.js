      ...
      <Header
        ...
        <View style={{
          ...
          <ScrollView style={{
            ...
            {
              "imageFiles" in this.state.product && this.state.product.imageFiles.length ?
                <>
                  <Carousel
                    layout={'default'}
                    ref={c => {
                    ...
                    data={this.state.product.imageFiles}
                  ...
                  />
                  {this.pagination}
                  <Text style={style.paginationCount}>{this.state.activeSlide + 1}/{this.state.product.imageFiles.length}</Text>
                </>
                : null
            }
            <View style={[style.businessInfoContent]}>
              ...
              <Text style={[theme.fontRegular, { fontSize: width / 35, color: '#979797', marginTop: 0, marginBottom: 15 }]}>
                {
                  moment(this.state.product.createdAt).format('LL')
                }
              </Text>
              <Text style={[{ color: AppColors.fontRed, fontSize: width / 30, marginBottom: 15 }]}>
                ID <Text style={[{ fontSize: width / 30, color: '#000' }]}>{this.state.product.productId}</Text>
              </Text>
            </View>
            <View style={[style.businessContactContent]}>
            {
                !this.state.product.bestDeal && 'price' in this.state.product ?
                  <View style={style.contacts}>
                    <TagSvg width={20} height={20} />
                    <Text style={[theme.fontRegular, { marginLeft: 13, fontSize: width / 21, color: AppColors.fontRed }]}>QAR {this.state.product.price}</Text>
                  </View>
                  : null
              }
               {
                this.state.product.bestDeal && 'actualPrice' in this.state.product ?
                  <View style={style.contacts}>
                    <TagSvg width={20} height={20} />
                    <Text style={[theme.fontRegular, { marginLeft: 13, fontSize: width / 21, color: AppColors.fontRed }]}>QAR</Text>
                    <Text style={[theme.fontRegular, { marginLeft: 5, fontSize: width / 21, color: AppColors.fontRed,  textDecorationLine: 'line-through', }]}>{this.state.product.actualPrice}</Text>
                    <Text style={[theme.fontRegular, { marginLeft: 5, fontSize: width / 21, color: AppColors.fontRed }]}>{this.state.product.offerPrice}</Text>
                    <Text style={[theme.fontRegular, { marginLeft: 3, fontSize: width / 21, color: '#5dc25a' }]}>({this.state.product.discountValue}%)</Text>
                  </View>
                  : null
              }
              {
                'mapDetails' in this.state.product && this.state.product.mapDetails ?
                  <View style={style.contacts}>
                    <LocatioPinSvg width={20} height={20} />
                    <Text style={[theme.fontRegular, { marginLeft: 13 }]}>{this.state.product.mapDetails.addressString}</Text>
                  </View>
                  : null
              }
              {
                'contactDetails' in this.state.product && this.state.product.contactDetails ?
                  <View style={style.contacts}>
                    <TimeSvg width={20} height={20} />
                    <Text style={[theme.fontRegular, { marginLeft: 14 }]}>Contact Time: </Text>
                    <Text style={[theme.fontRegular, { fontStyle: 'italic' }]}>{this.state.product.contactDetails.contactTimeFrom}</Text>
                    <Text style={[theme.fontRegular]}> to </Text>
                    <Text style={[theme.fontRegular, { fontStyle: 'italic' }]}>{this.state.product.contactDetails.contactTimeTo}</Text>
                  </View>
                  : null
              }
            </View>
            {
              'brandName' in this.state.product && this.state.product.brandName ?
                    ...
                    <View style={{
                      ...
                      <View style={{
                        ...
                        <View style={style.cell}>
                          <Text style={[theme.fontMedium, { fontSize: width / 29, color: '#3a3a3a' }]}>Brand: </Text>
                        </View>
                      </View>
                      <View style={{
                        flex: 2,
                        ...
                        <View style={style.cell}>
                          <Text style={[theme.fontMedium, { fontSize: width / 29, color: '#696969' }]}>{this.state.brandName}</Text>
                        </View>
                      </View>
                    </View>
                  </View>
            ...
            {
              'shortDescription' in this.state.product && this.state.product.shortDescription ?
                <View style={[style.aboutContent]}>
                  <Text style={[theme.fontBold, { fontSize: width / 25 }]}>
                    Description
                  </Text>
            ...
            {/* {
              'longDescription' in this.state.product && this.state.product.longDescription ?
                <View style={[style.aboutContent]}>
                  <Text style={[theme.fontBold, { fontSize: width / 25 }]}>
                    Long Description
                  </Text>
